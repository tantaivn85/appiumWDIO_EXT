import { HomePage, LoginPage, SearchPage } from "../src/pages/Index";

describe("ExoTrails app launch: ", () => {
...
describe("Navigation to Explore Tab (Home screen):", () => {
...
describe("Search functionality:", () => {
  it("Performs a search and checks results", async () => {
    const searchKeyword = "lam dong";
    await SearchPage.searchForTrail(searchKeyword);
